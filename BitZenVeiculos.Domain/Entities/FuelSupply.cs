...
namespace BitZenVeiculos.Domain.Entities
{
    public class FuelSupply
    {
        ...
        [NotEmptyGuid(ErrorMessage = "O responsável é obrigatório")]
        public Guid? ResponsibleUserId { get; set; }

        [NotEmptyGuid(ErrorMessage = "O veículo é obrigatório")]
        public Guid? VehicleId { get; set; }

        [Required(ErrorMessage = "A quilometragem do abastecimento é obrigatório")]
        [Range(0.5, 2000000, ErrorMessage = "A quilometragem do abastecimento deve estar entre o intervalo de 0.5 a 2.000.000 de quilometros")]
        ...
        [RangeCurrentDate(ErrorMessage = "A data inserida é inválida")]
